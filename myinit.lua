...
-- Tabline: each tab shows its number + cwd basename, + if any buffer is modified
-- function TabLine()
--   local s = ''
...
--       if vim.fn.getbufvar(buf, '&modified') == 1 then modified = true; break end
--     end
--     s = s .. i .. ':' .. name .. (modified and ' [+]' or '') .. ' '
--   end
